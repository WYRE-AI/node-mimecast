...
__export(src_exports, {
  MimecastAuthenticationError: () => MimecastAuthenticationError,
  MimecastClient: () => MimecastClient,
  MimecastError: () => MimecastError,
  MimecastForbiddenError: () => MimecastForbiddenError,
  MimecastNotFoundError: () => MimecastNotFoundError,
  MimecastRateLimitError: () => MimecastRateLimitError,
  MimecastServerError: () => MimecastServerError,
  MimecastValidationError: () => MimecastValidationError,
